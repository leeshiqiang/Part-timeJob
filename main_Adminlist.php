  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr>
        ...
        <th align="center" valign="middle" class="borderright">生日</th>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="center" valign="middle" class="borderright borderbottom">1996-1-1</td>
        <td align="center" valign="middle" class="borderright borderbottom">2018-4-25</td>
        ...
        <td align="center" valign="middle" class="borderbottom"><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">编辑</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">锁定</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">启用</a><span class="gray">&nbsp;|&nbsp;</span><a href="add.php" target="mainFrame" onFocus="this.blur()" class="add">删除</a></td>
      </tr>
